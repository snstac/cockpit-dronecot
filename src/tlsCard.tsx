...
/** Canonical TLS directory; readable by dronecot system user. */
export const TLS_DIR = '/etc/dronecot/tls';

const KEY_USER = 'dronecot';
...
export function TlsUploadCard({ onToast, onInstalledPaths }: TlsUploadCardProps) {
    ...
    return (
        <Card
            ...
            data-testid="dronecot-tls-card"
        >
            <CardHeader
                className="ct-card-expandable-header"
                onExpand={() => setExpanded(!expanded)}
                toggleButtonProps={{
                    id: 'dronecot-tls-expand',
